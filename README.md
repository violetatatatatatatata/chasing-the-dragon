...
Gemini ha dicho
Here is the README.md content in English and raw Markdown format as requested:
...
## Description
**Chasing the Dragon** is a 3D game engine inspired by the classic Wolfenstein 3D. Developed as the "cub3D" project within the 42 curriculum, its primary goal is to explore the principles of **Raycasting**—a technique used to create a 3D perspective from a 2D map.
